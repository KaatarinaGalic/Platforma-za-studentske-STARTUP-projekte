...
export default {
  ...
  methods: {
    async fetchUsers() {
      try {
        const response = await axios.get("http://summitvision.studenti.sum.ba/users");
    ...
    async deleteUser(userId) {
      ...
      try {
        await axios.delete(`http://summitvision.studenti.sum.ba/users/${userId}`);
    ...
    async updateUser() {
      try {
        await axios.put(`http://summitvision.studenti.sum.ba/users/${this.selectedUser.ID_korisnika}`, {
    ...
    async addUser() {
      try {
        ...
        const response = await axios.post("http://summitvision.studenti.sum.ba/register", {
    ...
    async fetchProjects() {
      try {
        const response = await axios.get("http://summitvision.studenti.sum.ba/projekti");
    ...
    async deleteProject(projectId) {
      ...
      try {
        await axios.delete(`http://summitvision.studenti.sum.ba/projekti/${projectId}`);
    ...
    async updateProject() {
      ...
      try {
        await axios.put("http://summitvision.studenti.sum.ba/projekti", {
    ...
    async addProject() {
      try {
        const response = await axios.post("http://summitvision.studenti.sum.ba/projects", {
    ...
    async fetchRegistriraniKorisnici() {
      try {
        const response = await axios.get("http://summitvision.studenti.sum.ba/registrirani_korisnici");
    ...
    async adminAddToProject() {
      try {
        const response = await axios.post('http://summitvision.studenti.sum.ba/admin-add-to-project', {
    ...
    async updateUserProject() {
      try {
        await axios.put(`http://summitvision.studenti.sum.ba/registrirani_korisnici/${this.selectedUser.ID_korisnika}`, {
    ...
    async removeUserFromProject(korisnik) {
      ...
      try {
        axios.delete('http://summitvision.studenti.sum.ba/registrirani_korisnici/' + korisnik.ID_korisnika)
        this.fetchRegistriraniKorisnici();
      } catch (error) {
    ...
    async fetchTechnologies() {
      try {
        const response = await axios.get("http://summitvision.studenti.sum.ba/technologies");
    ...
    async deleteTechnology(techId) {
      ...
      try {
        await axios.delete(`http://summitvision.studenti.sum.ba/technologies/${techId}`);
    ...
    async addTechnology() {
      try {
        const response = await axios.post("http://summitvision.studenti.sum.ba/technologies", {
    ...
    async fetchPendingProjects() {
      try {
        const response = await fetch("http://summitvision.studenti.sum.ba/api/projects/pending");
    ...
    async approveProject(projectId) {
      try {
        await axios.post(`http://summitvision.studenti.sum.ba/api/projects/approve/${projectId}`);
    ...
    async rejectProject(projectId) {
      ...
      try {
        await axios.post(`http://summitvision.studenti.sum.ba/api/projects/reject/${projectId}`);
        this.fetchPendingProjects();
      } catch (error) {
    ...
    async getLastSubmitterEmail() {
      try {
        const response = await axios.get('http://summitvision.studenti.sum.ba/api/projects/last-submitter');
